  ...
  return (
    <Card>
      ...
      <CardContent className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <Select
          value={form.brandIds}
          onChange={(event) => setForm((current) => ({ ...current, brandIds: event.target.value }))}
        ...
        <Select
          ...
          onChange={(event) => setForm((current) => ({ ...current, categoryIds: event.target.value }))}
