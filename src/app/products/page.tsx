  ...
  try {
    const [products, brands, categories] = await Promise.all([
      serverApi.products({
        ...
        brandIds: typeof params.brandIds === 'string' ? [params.brandIds] : undefined,
        ...
        sortOrder: typeof params.sortOrder === 'string' ? (params.sortOrder as never) : undefined,
        specifications: typeof params.specifications === 'string' ? params.specifications : undefined,
      }),
      serverApi.brands(),
    ...
    return (
      <div className="page-shell section-space space-y-8">
        <PageHeader eyebrow="Каталог" title="Обирайте смартфон під свій сценарій" />
